...
//        StrictMode.setThreadPolicy(policy);
        String busUrl = "http://openapitraffic.daejeon.go.kr/" + "api/rest/busRouteInfo/getStaionByRouteAll" +
                "?serviceKey=%2Fvx%2By1v3%2F%2BZ2ROElx9lg" +
                "Yq%2Fl47j%2BK6J8%2FBUyt8zupuWH6fDIzh3rNS" +
                "gbiENI9H3i8vbmfx7wcesxRwAV4rRl1Q%3D%3D&reqPage=1";
...
//        }
    ...
    private static class HTTPReqTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                String u = URLEncoder.encode("http://openapitraffic.daejeon.go.kr/" + "api/rest/busRouteInfo/getStaionByRouteAll" +
                        "?serviceKey=%2Fvx%2By1v3%2F%2BZ2ROElx9lg" +
                        "Yq%2Fl47j%2BK6J8%2FBUyt8zupuWH6fDIzh3rNS" +
                        "gbiENI9H3i8vbmfx7wcesxRwAV4rRl1Q%3D%3D&reqPage=1", "UTF-8");
                URL url = new URL(u);
